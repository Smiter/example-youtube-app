      ...
      <div className={style.main}>
        <div className={style.imgWrap}>
          <LazyLoad offsetVertical={450}>
            <a href={`http://youtu.be/${ video.id.videoId }`} target="_blank"><img width="300" src={video.snippet.thumbnails.medium.url} /></a>
          </LazyLoad>
        ...
        <div className={style.content}>
          ...
          <div className={style.description}><small>{ video.snippet.description }</small></div>
        </div>
      </div>
    );
  }
